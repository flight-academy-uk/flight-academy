...
- `apps/web-ui/tokens/` (`tokens.json` + JSON Schema + `tokens.css`) preserved as design source-of-truth; the `@theme` mapping into Tailwind lands alongside IBM Plex woff2 vendoring.
